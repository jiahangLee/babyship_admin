...
export default {
  ...
  effects: {
    ...
    * remove({payload: id}, {call, put, select}) {
      ...
      const page = yield select(state => state.issues.page);
    ...
    * createTeacher({payload: {values,editor}}, {call, put, select}) {
      yield call(usersService.createTeacher, {payload:{...values,editor}});
      const page = yield select(state => state.issues.page);
      yield put({type: 'fetchTeacher', payload: {page}});
    },
